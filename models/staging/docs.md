...
{% docs _deleted %}
Boolean indicating whether a record has been deleted in Hubspot and/or inferred deleted in Hubspot by Fivetran; _deleted and is_deleted fields are equivalent. 
{% enddocs %}
